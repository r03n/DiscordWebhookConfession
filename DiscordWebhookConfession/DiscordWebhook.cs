...
public class DiscordWebhook // code from https://github.com/MorganSkilly/Unity-Discord-Webhook-System/blob/main/Discord.cs
{
    //CHANGE THESE!
    public static string defaultWebhook = ""; // Your Discord Webhook Link
    private static string defaultUserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36"; // IDK about this lol
    public static string defaultUserName = "Confession"; // Discord Webhook Name
    public static string defaultAvatar = "https://i.imgur.com/nG5LHpt.jpeg"; // Discord Webhook Avatar
